...
export default function editProductDescription(props){
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await axios.post('/api/editProductDescription', {productID: productid,value: pDescription })
        .then(res=>{
        ...
        <Card>
            <CardContent className="layout">
                ...
                <Grid container spacing={1} columns={1} sx={{ py: 1, }}>
                        ...
                        <Grid xs={12} item sx={{py: 2,}}>
                            <TextField required fullWidth autoComplete="false" label="New Product Description" value={pDescription}
