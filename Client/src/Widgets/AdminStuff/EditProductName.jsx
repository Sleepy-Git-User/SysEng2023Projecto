...
export default function EditProductName(props){
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await axios.post('/api/editProductName', {productID: productid,value: pName })
        .then(res=>{
        ...
        <Card>
            <CardContent className="layout">
                ...
                <Grid container spacing={1} columns={1} sx={{ py: 1, }}>
                        ...
                        <Grid xs={12} item sx={{py: 2,}}>
                            <TextField required fullWidth autoComplete="false" label="New Product Name" value={pName}
